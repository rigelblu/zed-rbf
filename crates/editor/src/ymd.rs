use gpui::{FontStyle, HighlightStyle, Hsla, StrikethroughStyle, UnderlineStyle, px, rgba};
use std::ops::Range;
...
pub(crate) fn italic_style() -> HighlightStyle {
    HighlightStyle {
...
pub(crate) fn scan_italics(text: &str) -> Vec<Range<usize>> {
    scan_inline_style_content_ranges(text, "*")
}
